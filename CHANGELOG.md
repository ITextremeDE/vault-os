...
- Excluded the configured system tree and the visible `Vault-OS` instance
  directory recursively from the managed review queue.

## [0.3.1] - 2026-08-19

### Changed

- Replaced PARA dashboard task lists with compact task tables that show the
  task, its owning note, and its due date.
